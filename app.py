...
# 2D Graph
@app.callback(Output('2d_graph', 'figure'),
               [Input('s_input', 'value'),
               Input('r_input', 'value'),
               Input('q_input', 'value')])
def graph_2d(s, r, q):
    ...
    call_trace = [(go.Scatter(x=df_call["Strike"], y=df_call["IV"], name="2D Graph - Call", mode='lines',
                            marker={'size': 8, "opacity": 0.6, "line": {'width': 0.5}}, ))]
    df_put = calc_iv("put", s, r, q, "2D")
    put_trace = [(go.Scatter(x=df_put["Strike"], y=df_put["IV"], name="2D Graph - Put", mode='lines',
                              marker={'size': 8, "opacity": 0.6, "line": {'width': 0.5}}, ))]
...
def make_heatmap_plot(option, s, r, q, graph_toggles,
...
def make_scatter_plot(option, s, r, q, graph_toggles,
